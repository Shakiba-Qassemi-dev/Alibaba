...
export default function Footer() {
  return (
<>
<section className="flex flex-col md:flex-row justify-center gap-10 items-center w-[80%]  border-t-2 border-gray-400 mx-auto mt-20">
      <div className="flex flex-col md:flex-row w-[30%] items-center justify-center gap-2">
        <div><img src="/images/rotbeh.webp"/></div>
        <div className="flex flex-col gap-1">
          <h1 className="font-bold">رتبه یک سفر</h1>
          <h4>معتبرترین عرضه‌کننده محصولات گردشگری در ایران</h4>
        </div>
      </div>
      <div className="flex flex-col md:flex-row w-[30%] items-center justify-center gap-2">
        <div><img src="/images/hamsafar.webp"/></div>
        <div className="flex flex-col gap-1">
          <h1 className="font-bold"> همسفر هر سفر</h1>
          <h4>ارائه تمامی خدمات سفر (پرواز، قطار، اتوبوس، هتل و تور)</h4>
        </div>
      </div>
      
      <div className="flex flex-col md:flex-row w-[30%] items-center justify-center gap-2">
        <div><img src="/images/lahzeh.webp"/></div>
        <div className="flex flex-col gap-1">
          <h1 className="font-bold"> همسفر همه لحظات سفر </h1>
          <h4>پشتیبانی و همراهی ۲۴ ساعته در تمامی مراحل سفر</h4>
        </div>
      </div>
     </section>

     <footer className='w-[80%] mx-auto flex flex-col md:flex-row justify-center items-center mt-20 mb-14'>
      <div className='flex flex-col md:flex-row gap-9 md:gap-20 md:w-[50%] w-full items-center md:items-baseline'>
        <div className='flex flex-col gap-3 *:hover:text-blue-600'>
          <a href='#' className='font-bold'>علی بابا</a>
          <a href='#'>درباره ی ما</a>
          <a href='#'>تماس با ما</a>
          <a href='#'>چرا علی بابا</a>
          <a href='#'>علی بابا پلاس</a>
          <a href='#'> بیمه ی مسافرتی</a>
        </div>
        <div className='flex flex-col gap-3 *:hover:text-blue-600'>
          <a href='#' className='font-bold'>خدمات مشتریان</a>
          <a href='#'>مرکز پشتیبانی انلاین</a>
        ...
        <div className='flex flex-col gap-3 *:hover:text-blue-600'>
          <a href='#' className='font-bold'>اطلاعات تکمیلی</a>
          <a href='#'>فروش سازمانی</a>
          <a href='#'>پنل اژانسی علی بابا</a>
          <a href='#'>فرصت های شغلی</a>
          <a href='#'>سنحش رضایت مندی</a>
        </div>
      </div>
      ...
      <div className='flex flex-col gap-8 items-center md:items-end md:w-[50%] w-full mt-4 md:mt-0'>
        <img src='/images/logo.webp'/>
        <h1>تلفن پشتیبانی: ۰۲۱ - ۴۳۹۰۰۰۰۰</h1>
        <div className='flex flex-col md:flex-row  gap-2'>
          <img src='/images/sazman.webp' className='w-[70px] h-[70px]'/>
          <img src='/images/nerkh.webp' className='w-[70px] h-[70px]'/>
          <img src='/images/reza.webp' className='w-[70px] h-[70px]'/>
          <img src='/images/barcode.webp' className='w-[70px] h-[70px]'/>
        </div>
      </div>
